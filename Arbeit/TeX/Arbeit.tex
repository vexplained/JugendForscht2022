...
\usepackage{graphicx}
\graphicspath{{./rsc/img/(1)}{./rsc/img/(2)}{./rsc/flowcharts}}
...
% Footnote: \footcite{reference}
\usepackage[style=numeric,backend=bibtex]{biblatex}
% \usepackage[citestyle=numeric,bibstyle=authortitle,backend=bibtex]{biblatex}
...
\input{sections/(0)Kurzfassung.tex}
...
\section{Ergebnisse}
\input{sections/(3)Ergebnisse.tex}

\section{Ergebnisdiskussion}
\input{sections/(4)Ergebnisdiskussion.tex}

\section{Zusammenfassung}
\input{sections/(5)Zusammenfassung.tex}
...
\input{sections/(8)Unterstützungsleistungen.tex}
