 ...
 * @author S.K. Kwak
 * 
 * @see https://github.com/etomica/etomica/blob/master/etomica-core/src/main/java/etomica/graphics/DecimalSlider.java
 */
public class DecimalSlider extends JSlider
{

	private static final long serialVersionUID = -1619130428044138405L;
	...
	public void setPrecision(int p)
	{
		...
		setDecimalSliderLabelTable(createDecimalSliderStandardLabels(s));
	}
	...
	public int getDecimalSliderMinimum()
	{
	...
	public int getDecimalSliderMajorTickSpacing()
	{
	...
	public int getDecimalSliderMinorTickSpacing()
	{
		return super.getMinorTickSpacing();
	}
